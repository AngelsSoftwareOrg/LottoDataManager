...
{
    public static class MachineLearningModelBuilderSDCARegression
    {
        //private static string TRAIN_DATA_FILEPATH = @"D:\Development\WorkSpace00003\Datasets\all_eg007.csv";
        ...
        public static void CreateModel(String trainDataFilePath)
        {
            // Load Data
        ...
        private static void Evaluate(MLContext mlContext, IDataView trainingDataView, IEstimator<ITransformer> trainingPipeline)
        {
            ...
            var crossValidationResults = mlContext.Regression.CrossValidate(trainingDataView, trainingPipeline, numberOfFolds: 5, labelColumnName: "PREDICT");
