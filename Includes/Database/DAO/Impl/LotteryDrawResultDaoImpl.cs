    ...
    public class LotteryDrawResultDaoImpl: LotteryDrawResultDao
    {
        ...
        public LotteryDrawResult GetLotteryDrawResultByDrawDate(GameMode gameMode, DateTime drawDate)
        {
            ...
            using (OleDbCommand command = new OleDbCommand())
            {
                ...
                command.Parameters.Add("@drawDate", OleDbType.DBDate).Value = drawDate.ToString();
                command.Connection = conn;
                conn.Open();
        ...
        public LotteryDrawResult GetLatestDrawResult(int gameCd)
        {
            ...
            using (OleDbCommand command = new OleDbCommand())
            {
                ...
                command.Parameters.Add("@game_cd", OleDbType.Variant).Value = gameCd.ToString();
                command.Connection = conn;
                conn.Open();
                using (OleDbDataReader reader = command.ExecuteReader())
                {
        ...
        public List<LotteryDrawResult> GetDrawResultsFromStartingDate(GameMode gameMode, DateTime startingDrawDate, DateTime endingDate)
        {
            ...
            using (OleDbCommand command = new OleDbCommand())
            {
                ...
                command.CommandText = GetStandardSelectQuery() +
                                      ...
                                      " ORDER BY draw_date DESC";
                command.Parameters.Add("@game_cd", OleDbType.Integer).Value = (int)gameMode;
                command.Parameters.Add("@startingDrawDate", OleDbType.DBDate).Value = startingDrawDate.ToString();
                command.Parameters.Add("@endingDate", OleDbType.DBDate).Value = endingDate.ToString();
        ...
        public DateTime GetNextDrawDate(GameMode gameMode, DateTime betDate)
        {
            ...
            using (OleDbCommand command = new OleDbCommand())
            {
                ...
                command.Parameters.Add("@game_cd", OleDbType.Integer).Value = (int)gameMode;
                command.Parameters.Add("@betDate", OleDbType.DBDate).Value = betDate.ToString();
                command.Connection = conn;
                conn.Open();
        ...
        public void InsertDrawDate(LotteryDrawResult lotteryDrawResult)
        {
            ...
            using (OleDbCommand command = new OleDbCommand())
            {
                ...
                command.Parameters.Add("@draw_date", OleDbType.DBDate).Value = lotteryDrawResult.GetDrawDate();
                command.Parameters.Add("@jackpot_amt", OleDbType.Double).Value = lotteryDrawResult.GetJackpotAmt();
                command.Parameters.Add("@winners", OleDbType.Integer).Value = lotteryDrawResult.GetWinnersCount();
                command.Parameters.Add("@game_cd", OleDbType.Integer).Value = lotteryDrawResult.GetGameCode();
                command.Parameters.Add("@num1", OleDbType.Integer).Value = lotteryDrawResult.GetNum1();
                command.Parameters.Add("@num2", OleDbType.Integer).Value = lotteryDrawResult.GetNum2();
                command.Parameters.Add("@num3", OleDbType.Integer).Value = lotteryDrawResult.GetNum3();
                command.Parameters.Add("@num4", OleDbType.Integer).Value = lotteryDrawResult.GetNum4();
                command.Parameters.Add("@num5", OleDbType.Integer).Value = lotteryDrawResult.GetNum5();
                command.Parameters.Add("@num6", OleDbType.Integer).Value = lotteryDrawResult.GetNum6();
                command.Connection = conn;
                conn.Open();
        ...
        public List<int> GetTopDrawnPreviousSeasonDigitResults(GameMode gameMode)
        {
            ...
            using (OleDbCommand command = new OleDbCommand())
            {
                ...
                command.Parameters.Add("@game_cd", OleDbType.Integer).Value = (int)gameMode;
                command.Parameters.Add("@fromDate", OleDbType.DBDate).Value = fromDate.Date.ToString();
                command.Parameters.Add("@toDate", OleDbType.DBDate).Value = toDate.Date.ToString();
                command.Parameters.Add("@fromDate", OleDbType.DBDate).Value = fromDate.Date.ToString();
                command.Connection = conn;
                conn.Open();
        ...
        public List<int> GetTopDrawnDigitFromDateRange(GameMode gameMode, DateTime dateFrom, DateTime dateTo)
        {
            ...
            using (OleDbCommand command = new OleDbCommand())
            {
                ...
                command.Parameters.Add("@game_cd", OleDbType.Integer).Value = (int)gameMode;
                command.Parameters.Add("@dateFrom", OleDbType.DBDate).Value = dateFrom.Date.ToString();
        ...
        private OleDbCommand GetDrawResultCommandByRange(GameMode gameMode, DateTime fromDate, DateTime toDate)
        {
            OleDbCommand command = new OleDbCommand(
                ...
                "           AND CDate(@date_to))");
            command.Parameters.Add("@game_cd", OleDbType.Integer).Value = gameMode;
            command.Parameters.Add("@date_from", OleDbType.DBDate).Value = fromDate;
            command.Parameters.Add("@date_to", OleDbType.DBDate).Value = (toDate == null) ? fromDate : toDate;
            return command;
        }
